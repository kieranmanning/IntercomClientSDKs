...
class OAuthDeviceFlowApi:
    ...
    def v1_oauth_token_create(
        ...
        client_id: Annotated[str, Field(strict=True, max_length=64)],
        device_code: Optional[Annotated[str, Field(strict=True, max_length=64)]] = None,
        refresh_token: Optional[Annotated[str, Field(strict=True, max_length=64)]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
